...
import { RouterAction, ParsedHash, ParsedSearch } from './index';
...
export declare function Link<Route extends string>({ dispatch, route, pushHistory, match, hash, search, ...rest }: RouterLinkProps<Route> & {
    route: Route;
    match?: {
...
export declare function LinkRef<Route extends string>({ dispatch, route, pushHistory, match, hash, search, ...rest }: RouterLinkProps<Route> & {
    route: Route;
    match?: {
        [key: string]: string | undefined;
    };
    ...
    hash?: ParsedHash;
    search?: ParsedSearch;
}, ref: Ref<HTMLAnchorElement>): React.ForwardRefExoticComponent<Pick<{
    dispatch: Dispatch<RouterAction<Route>>;
} & Omit<React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, "href"> & {
    route: Route;
    match?: {
